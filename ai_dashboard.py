...
if page == "Charts":
    st.subheader("🗂️ Select Chart Category")
    chart_category = st.radio("Choose a category:", ["📈 AI and Agile Insights", "🏢 Respondents Profile"])

    if chart_category == "📈 AI and Agile Insights":
        ...
        # Strategic Impact of AI and Agile
    ...
    elif chart_category == "🏢 Respondents Profile":
